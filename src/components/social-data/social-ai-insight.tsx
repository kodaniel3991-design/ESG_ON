...
import type { SocialAiInsight } from "@/types/social-data";
import { Sparkles, AlertTriangle } from "lucide-react";

interface SocialAiInsightProps {
  data: SocialAiInsight;
}

/** 사회 데이터 AI 인사이트 패널 */
export function SocialAiInsight({ data }: SocialAiInsightProps) {
  return (
