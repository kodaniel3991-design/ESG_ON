          ...
          <table className="w-full min-w-[1100px] text-sm">
                ...
                {MONTH_LABELS.map((label, idx) => {
                  ...
                  return (
                    <th key={label} className={cn(
                      ...
                      isSelected ? "bg-primary/10 text-primary" : isCurrent ? "bg-taupe-50 text-carbon-warning dark:bg-taupe-50/30 dark:text-carbon-warning" : ""
                    )}>
                      {label}
            ...
            <tbody>
              ...
              <tr className="border-b border-border/60 bg-muted/20">
                ...
                {gasEmissions.co2.map((v, idx) => <td key={idx} className={cn("px-2 py-2 text-right text-xs text-muted-foreground", isCurrentYear && idx === currentMonthIdx && "bg-taupe-50/60 dark:bg-taupe-50/10")}>{formatNumber(v, 3)}</td>)}
              ...
              <tr className="border-b border-border/60 bg-muted/20">
                ...
                {gasEmissions.ch4.map((v, idx) => <td key={idx} className={cn("px-2 py-2 text-right text-xs text-muted-foreground", isCurrentYear && idx === currentMonthIdx && "bg-taupe-50/60 dark:bg-taupe-50/10")}>{formatNumber(v, 3)}</td>)}
              ...
              <tr className="bg-muted/20">
                ...
                {gasEmissions.n2o.map((v, idx) => <td key={idx} className={cn("px-2 py-2 text-right text-xs text-muted-foreground", isCurrentYear && idx === currentMonthIdx && "bg-taupe-50/60 dark:bg-taupe-50/10")}>{formatNumber(v, 3)}</td>)}
