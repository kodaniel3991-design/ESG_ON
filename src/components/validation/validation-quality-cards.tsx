...
import type { ValidationQualityScore } from "@/types/validation-data";
import { cn } from "@/lib/utils";

interface ValidationQualityCardsProps {
  items: ValidationQualityScore[];
}
...
/** 검증 품질 카드 - Environment Data Quality 카드 구조 재사용 */
export function ValidationQualityCards({
  items,
}: ValidationQualityCardsProps) {
