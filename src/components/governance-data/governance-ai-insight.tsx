...
import type { GovernanceAiInsight } from "@/types/governance-data";
import { Sparkles, AlertTriangle } from "lucide-react";

interface GovernanceAiInsightProps {
  data: GovernanceAiInsight;
}

/** 거버넌스 AI 인사이트 패널 */
export function GovernanceAiInsight({ data }: GovernanceAiInsightProps) {
  return (
